...
- `frontend/csapi.d.ts` : The custom scripting API TypeScript definitions. CozySSH itself doesn't use this file. Generated by `npx dts-bundle-generator --project ./frontend/tsconfig.app.json ./frontend/src/window.d.ts --inline-declare-global --external-types=react --external-inlines=@xterm/xterm --external-inlines=@xterm/addon-search --external-inlines=zustand --external-inlines=csstype -o frontend/csapi.d.ts`
