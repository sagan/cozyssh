...
export interface VirtualKeyboard extends EventTarget {
	...
	show(): void;
	hide(): void;
	addEventListener(type: "geometrychange", listener: (this: VirtualKeyboard, ev: Event) => unknown, options?: boolean | AddEventListenerOptions): void;
}
declare global {
	interface Navigator {
	...
	interface Window {
		...
		csOpen: (target: HostData | string | (HostData | string)[], options?: {
			name?: string;
		}) => void;
		...
		csSetVar: ((nameOrVars: string, value: string | undefined) => Promise<void>) | ((vars: Record<string, string | undefined>) => Promise<void>);
		...
		csOpenApplet(name: string, node: Node | React.ComponentType, options?: {
			position?: AppletPosition;
			width?: number;
			height?: number;
		}): void;
