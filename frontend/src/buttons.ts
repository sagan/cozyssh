...
export const TERMINAL_FUNCTIONS = [
  ...
  { value: "SELECT_TO_PREV_CHAR", label: t("Select to Previous Character") },
  { value: "SELECT_TO_NEXT_CHAR", label: t("Select to Next Character") },
  { value: "SELECT_TO_PREV_WORD", label: t("Select to Previous Word") },
  { value: "SELECT_TO_NEXT_WORD", label: t("Select to Next Word") },
  { value: "SELECT_TO_WORD_END", label: t("Select to Word End") },
  { value: "SELECT_TO_PREV_LINE", label: t("Select to Previous Line") },
  { value: "SELECT_TO_NEXT_LINE", label: t("Select to Next Line") },
